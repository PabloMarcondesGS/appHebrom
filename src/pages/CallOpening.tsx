      ...
      <View style={styles.content}>
        ...
        <View style={styles.body}>
          ...
          <ScrollView style={styles.scrow}>
            {release ? (
              calls.map((data: callDTO) => (
                <TouchableOpacity
                  style={styles.card}
                  onPress={() => navigation.navigate("ViewCalled")}
                  key={data.codSacAtend}
                >
        ...
        >
          <Text style={styles.buttonText}>ABERTURA DE TICKET</Text>
        </RectButton>
      </View>
    </SafeAreaView>
  );

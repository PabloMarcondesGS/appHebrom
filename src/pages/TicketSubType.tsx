...
export const TicketSubType: React.FC = () => {
  ...
  const handleSubmit = async () => {
    await AsyncStorage.setItem("TicketSubType", value);
    navigation.navigate("TicketsandSuport");
  };
  return (
      ...
      <View style={styles.content}>
        ...
        <View style={styles.body}>
          <Text style={styles.title}>
            Qual é o subtipo de chamado que deseja abrir?
          </Text>
          ...
          <View style={styles.GroupOptions}>
            <RectButton style={styles.Options} onPress={handleOne}>
              <Text style={styles.ButtonOptions}>segunda via de boleto</Text>
              {optionOne && (
                <AntDesign name="check" size={24} color="#808080" />
              )}
            </RectButton>
            <RectButton onPress={handleTwo} style={styles.Options}>
              <Text style={styles.ButtonOptions}>sac</Text>
              {optionTwo && (
                <AntDesign name="check" size={24} color="#808080" />
              )}
            </RectButton>
            <RectButton onPress={handleThree} style={styles.Options}>
              <Text style={styles.ButtonOptions}>emissao de carteirinhas</Text>
              {optionThree && (
                <AntDesign name="check" size={24} color="#808080" />
              )}
            </RectButton>
            <RectButton onPress={handleFour} style={styles.Options}>
              <Text style={styles.ButtonOptions}>atendimento</Text>
              {optionFour && (
                <AntDesign name="check" size={24} color="#808080" />
              )}
            </RectButton>
          ...
          <View style={styles.BoxInput}>
            <View style={styles.groupButtons}>
              <RectButton
                ...
                onPress={() => navigation.navigate("TicketType")}
              >
